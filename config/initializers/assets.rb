...
Rails.application.config.assets.precompile += %w( competencies.js.coffee )
...
Rails.application.config.assets.precompile += %w( step3.js.coffee )
Rails.application.config.assets.precompile += %w( step4.js.coffee )
Rails.application.config.assets.precompile += %w( step5.js.coffee )
